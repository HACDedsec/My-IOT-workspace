...
#define AUTH "pw-j1XkElVsDRvuGnqlwey5avEodljj2"  // You should get Auth Token in the Blynk App.  
#define WIFI_SSID "smarthome"                   //Enter Wifi Name
#define WIFI_PASS "password@#1"                   //Enter wifi Password
