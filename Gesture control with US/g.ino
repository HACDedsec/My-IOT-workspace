const int trigger1 = D0; //Trigger pin of 1st Sesnor
const int echo1 = D1; //Echo pin of 1st Sesnor
const int trigger2 = D2; //Trigger pin of 2nd Sesnor
const int echo2 = D3;//Echo pin of 2nd Sesnor
