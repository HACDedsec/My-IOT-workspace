...
// WiFi Credentials
const char* ssid = "maharaja granite";
const char* password = "Rajaghera@2323";

//const char* ssid = "smarthome";
//const char* password = "password@#1";

// device names as per node mcu default is 8 pin
String Device_1_Name = "Left Light";
String Device_2_Name = "Display Light";
String Device_3_Name = "Fan";
String Device_4_Name = "DADA";
String Device_5_Name = "Display Up ";
String Device_6_Name = "Center Light";
String Device_7_Name = "Bell";
String Device_8_Name = "Right Light";
